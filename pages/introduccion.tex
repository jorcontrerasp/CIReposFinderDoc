...
``CI'' siempre se refiere a la integración continua, que es un proceso de automatización para los desarrolladores. El éxito de la CI implica que se diseñen, prueben y combinen los cambios nuevos en el código de una aplicación con regularidad en un repositorio compartido.
...
%\end{figure}
    ...
    - \textbf{\underline{GitLab CI}}: es la parte de GitLab que secusa para todos los métodos continuos (integración continua, entrega e implementación). Con GitLab CI/CD se puede probar, crear y publicar software sin necesidad de una aplicación o integración de terceros.
\begin{figure}[h]
    \centering
