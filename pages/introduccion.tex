...
Además, una buena práctica consiste en incluir la capacidad de revertir automáticamente todos los cambios aplicados en la implementación.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth,clip=true]{\logoGitHubActions}
