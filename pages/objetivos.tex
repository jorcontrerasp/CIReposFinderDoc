...
\begin{compactitem}
    ...
    \item ¿Cuántos trabajos\cotutor{¿A qué te refieres con trabajos? Si te refieres a los Jobs, yo usaría la palabra en ingles, "trabajos" suena extraño en este contexto} suelen haber \cotutor{Los Jobs en realidad están en el archivo de configuración (y este en el repositorio)} en repositorios ``open source''?
...
\begin{compactitem}
    \item Número de trabajos.\cotutor{Igual, menor hablar de jobs}
...
\cotutor{Esta sección parece el primer paso seguido de la metodología, ¿no debería ser por lo tanto una subsección? Quizás la metología podría ir en su propia sección y sus subsecciones fueran cada uno de los puntos citados en el párrafo anterio}
...
Los sistemas de CI identificados son los siguientes:\cotutor{Estos son los sistemas de trabajo identificados por la herramienta o los que Patxi propuso en un primer momento? Si es lo segundo, hay que especificar que estos sistemas de CI se identificaron ANTES de comenzar el experimento}
\begin{compactitem}
