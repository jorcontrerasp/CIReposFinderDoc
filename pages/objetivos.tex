...
\begin{compactitem}
    ...
    \item ¿Cuántos trabajos\cotutor{¿A qué te refieres con trabajos? Creo que sería mejor denominarlos flujos de trabajo/workflows} suelen haber en repositorios ``open source''?
...
\begin{compactitem}
    \item Número de trabajos.\cotutor{Igual, menor hablar de flujos de trabajo}
