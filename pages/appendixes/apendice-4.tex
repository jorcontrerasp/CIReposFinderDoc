\section{Error PyYaml: ejemplo de fichero CI}
\label{sec:errorPyYaml}

\begin{lstlisting}[caption=Fichero YAML CI del proyecto GitLab ``leapsight/bondy'']
name: CI
on:
  push:
  ...
  docker:
    ...
    steps:
      ...
      -
        ...
        with:
          images: ${{ github.repository }}/bondy
          tags: |
       ...
       - 
        ...
        with:
          ...
          push: true
          tags: docker.io/${{ steps.meta.outputs.tags }}
      -
        ...
        with:
          ...
          platforms: linux/amd64,linux/arm64
          push: true
          tags: docker.io/${{ steps.meta.outputs.tags }}-alpine
      -
