...
\begin{compactitem}
    \item \textbf{Ficheros de resultados}: Ficheros excel que van a componer matrices repositorio de GitHub o GitLab/herramienta de CI indicando en su intersección mediante una ``***'' si el repositorio X utiliza o no laherramienta de integración continua Y.
