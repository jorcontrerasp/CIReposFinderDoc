...
A modo de resumen, se expone a continuación el flujo de ejecución del programa:\cotutor{Ambas figuras son demasiado grandes. Quizás sea mejor moverlas a un anexo.}
...
\cotutor{Yo pondría "Error 403 - API rate limit exceeded for user ID XXXXXXX".}
...
\alumno{No se ve bien la excepción. Revisar.}
\cotutor{Igual, con el status code y el mensaje de la excepción es suficiente}
