...
En este proyecto se aborda la elaboración de un estudio sobre los diferentes sistemas de integración continua que podemos encontrar en repositorios de código abierto almacenados en las plataformas de GitHub y GitLab.\\
El principal objetivo de este estudio es conocer información relativa a el uso que se le dan a estos sistemas de integración contínua, como por ejemplo, conocer cuál es la herramienta predominante en cada plataforma, si se suelen combinar más de una herramienta de este tipo en un mismo repositorio, la finalidad de uso de cada herramienta, etc.\\
Para ello se ha implementado un programa en Python encargado de devolver la información necesaria para realizar el estudio.
